...
describe("GET /v1/auth/user", () => {
    ...
    it("should get user", async () => {
        ...
        const response = await chaiRequest("GET", "/v1/auth/user", accessToken1.token);
    ...
    it("should fail fetching user using invalid access token", async () => {
        ...
        const response = await chaiRequest("GET", "/v1/auth/user", "2b266900-96c0-4788-8746-21bd629e4468");
